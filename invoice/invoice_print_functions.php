...
//* Header                                                             //*header
//*header titlebar                                                             *
echo "<tr> <td ".$fmt_prt[0]."  > <table border=$mtborder dir=rtl>";

//* header inner datacells                                                     *
//*header left                                                                 *
echo "      <td width=$hlwidth> <table border=$itborder> ";
showrow(array("العميل : &nbsp;$acctno"),$inputfmnd_prt);
...
showrow(array("الصفحة",$ppp),$inputfmw_prt );
echo " </table>                          </td>";
...
function lineitem_header()  {
 ...
 echo " <tr> <td > <table border=$mtborder dir=rtl >";
 $size= array(); $size[0]=1;
                 $size[1]=1;
                 $size[2]=1;
                 $size[3]=1;
                 ...
                 $size[11]=1;
                 $size[12]=1;
                 $size[13]=1;//textsize - always small for header.
...
global $lc;
 ...
 echo "<table border=$otborder cellspacing=$ospacing width=$otw style=\"margin:auto;\" dir=rtl>";       //*outer
