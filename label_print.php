...
echo "
<table class=\"ticket\"   border=$outer_border  dir=\"rtl\" style=\"text-align:center; font-weight:bold;\">
<tr>
<td colspan=\"4\" style=\"font-size:22px !important;\">".SITENAME."</td>
</tr>
<tr>
<td style=\"background: #ccc;\" >التاريخ</td>
<td style=\"background: #ccc;\">" . date("d-m-Y", strtotime($order['pickup_date'])) . "</td>
<td >العميل</td>
<td >" . $order['account_company'] . "</td>
</tr>
<tr>
<td style=\"background: #ccc;\">رقم البون</td>
<td >" . $order['easy_order_id'] . " - " . $order["part_order"] . "</td>
<td style=\"background: #ccc;\">عملية</td>
<td >" . $order['office_name'] . " - " . $order['operation_name'] . "</td>
</tr>
<tr>
<td style=\"background: #ccc;\">المقاس</td>
<td colspan=\"3\">
<table border=$outer_border  style=\"text-align:center; width:100%; font-weight:bold;\" ><tr>
<td style=\"font-size:22px !important;\">".$order['length']."</td>
<td style=\"font-size:22px !important;\">".$order['width']."</td>
<td >".$order['glassPointing'] ."</td>
</tr>
</table>
</td>
</tr>
<tr>
<td style=\"background: #ccc;\">التوصيف</td>
<td >".$order['package_short']."</td>
<td >".($order['glasscolour'] == 'شفاف' ? 'ابيض' : $order['glasscolour'])."</td>
<td >".($print_type == 'شامل' ? 'سيكوريت' : $print_type)."</td>
</tr>
<tr>
<td style=\"background: #ccc;\">النوع</td>
<td >" . $work_status_lang[$order['work_status']] . "</td>
<td colspan=\"2\">" . $order['glassType'] . "</td>

</tr>
<tr>
<td style=\"background: #ccc;\">ملاحظات</td>
<td colspan=\"3\">" . $comments . "</td>
</tr>
<tr>
<td style=\"background: #ccc;\">ملاحظات</td>
<td colspan=\"3\">" . $order['details_2'] . "</td>
</tr>
<tr>
<td colspan=\"4\"><img src=\"data:image/png;base64," . base64_encode($generator->getBarcode($order['barcode'], $generator::TYPE_CODE_128)) . "\" ></td>
</tr>
</table>
";
...
// echo "</table>";    // *** close the big table.
