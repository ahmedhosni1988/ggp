...
switch ($action) {
    ...
    case 'add_purchase':
        if ($_POST['bill_no']) {
            ...
            $accountsData = $account->get_accounts(5);
    ...
    case 'Suppliers':
        $accounts = $account->get_accounts(5);
    ...
    case 'account_details':
        if (isset($_GET['account_id']) && $_GET['account_id'] != '') {
            ...
            if (isset($_POST["account_name"])) {
                ...
                $num = check_duplication("account", "account_name", $_POST['account_name'], "5");
    ...
    default:
        $newtemp->load_template('invenotry_main', 4);
        break;
}
