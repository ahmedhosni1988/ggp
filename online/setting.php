...
define("SITEURL", "http://pyramids.local");
define("HOSTNAME", "localhost");
define("DBUSER", "admin");
define("DBPASS", "!!ZorkMid16");
define("DBNAME", "server_db");
...
if (isset($_SESSION['status']) && $_SESSION['status'] == 1) {
    define("formurl", "http://pyramids.local/client");
...
if (isset($_SESSION['status']) && $_SESSION['status'] == 2) {
    define("formurl", "http://pyramids.local/administrator");
